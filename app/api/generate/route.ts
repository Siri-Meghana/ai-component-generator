...
2. Use Tailwind CSS for styling (utility classes only - no custom CSS)
3. Include comprehensive accessibility features:
   - Semantic HTML elements (button, nav, header, main, article, etc.)
   - ARIA labels, roles, and properties where appropriate
   - Keyboard navigation support (Tab, Enter, Escape, Arrow keys as needed)
...
5. Make components responsive (mobile-first approach)
6. Add brief comments explaining accessibility choices
7. Use modern, clean design patterns

CRITICAL: Output ONLY the component code. No markdown formatting, no backticks, no explanations before or after. Just pure TypeScript/React code that can be directly copied into a .tsx file.`,
        },
        {
          role: 'user',
          content: prompt,
